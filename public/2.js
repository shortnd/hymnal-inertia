...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    date: function date() {
      return moment__WEBPACK_IMPORTED_MODULE_0___default()(this.$page.user.last_login_at).format("MMMM Do YYYY, h:mm:ss a");
    }
  },
  methods: {
      ...
      _c(
        ...
        [
          ...
          _c("ul", { staticClass: "mr-auto navbar-nav" }, [
            _vm.$page.user && _vm.$page.user.playersAllowed
              ? _c(
                  "li",
          ...
          _c(
            "ul",
            { staticClass: "ml-auto navbar-nav" },
            [
              !_vm.$page.user
                ? [
                    _c(
